...
`);y(l)}}catch(a){console.warn("Failed to format code:",a)}},h=a=>{var d;const o=(d=a.split(".").pop())==null?void 0:d.toLowerCase();return{tsx:"typescript",ts:"typescript",jsx:"javascript",js:"javascript",css:"css",json:"json",html:"html",md:"markdown"}[o||""]||"typescript"};u.useEffect(()=>{if(N){const a=h(N);D(a)}},[N]);const x=`
...
export default ${t};
`,$=()=>{var t,n,i,h,x,j,a,o,l,d,c,f,b,C,P,U,z,A,w,R;return s?`/* ${s.metadata.name} Theme Styles */
...
.container {
  ...
  margin: 0 auto;
  padding: 0 ${((R=(w=(A=s.config)==null?void 0:A.layout)==null?void 0:w.spacing)==null?void 0:R.md)||"1.5rem"};
}
...
${(t=s.config)!=null&&t.features?Object.entries(s.config.features).map(([w,R])=>`- **${w}**: ${R?"Enabled":"Disabled"}`).join(`
...
`:""},v=t=>{p(n=>({...n,currentFile:t})),N(t.content||"")},D=t=>{N(t),p(n=>({...n,hasUnsavedChanges:!0,saveStatus:"idle"}))},y=async()=>{if(r.currentFile){p(t=>({...t,saveStatus:"saving"}));try{const t=r.files.map(n=>{var i;return n.path===((i=r.currentFile)==null?void 0:i.path)?{...n,content:S,modified:!0}:n});p(n=>({...n,files:t,hasUnsavedChanges:!1,saveStatus:"saved"})),setTimeout(()=>{p(n=>({...n,saveStatus:"idle"}))},3e3)}catch(t){console.error("Failed to save file:",t),p(n=>({...n,saveStatus:"error"}))}}},M=()=>{r.hasUnsavedChanges?confirm("You have unsaved changes. Are you sure you want to leave?")&&F("/admin/themes"):F("/admin/themes")},O=()=>{p(t=>({...t,previewMode:!t.previewMode}))};return s?e.jsxs("div",{className:"p-6 space-y-6",children:[e.jsxs("div",{className:"flex items-center justify-between",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs(k,{variant:"outline",size:"sm",onClick:M,children:[e.jsx(ie,{className:"h-4 w-4 mr-2"}),"Back to Themes"]}),e.jsxs("div",{children:[e.jsx("h1",{className:"text-2xl font-bold",children:"Theme Code Editor"}),e.jsxs("p",{className:"text-muted-foreground",children:["Edit ",s.metadata.name," theme files"]})]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[r.hasUnsavedChanges&&e.jsx(I,{variant:"secondary",children:"Unsaved Changes"}),r.saveStatus==="saved"&&e.jsxs(I,{variant:"default",className:"bg-green-600",children:[e.jsx(W,{className:"h-3 w-3 mr-1"}),"Saved"]}),e.jsxs(k,{variant:"outline",onClick:O,children:[e.jsx(ce,{className:"h-4 w-4 mr-2"}),r.previewMode?"Edit":"Preview"]}),e.jsxs(k,{onClick:y,disabled:!r.hasUnsavedChanges||r.saveStatus==="saving",children:[e.jsx(q,{className:"h-4 w-4 mr-2"}),r.saveStatus==="saving"?"Saving...":"Save"]})]})]}),e.jsxs("div",{className:"grid grid-cols-12 gap-6 h-[calc(100vh-200px)]",children:[e.jsx("div",{className:"col-span-3",children:e.jsxs(V,{className:"h-full",children:[e.jsx(H,{children:e.jsxs(G,{className:"text-base flex items-center gap-2",children:[e.jsx(he,{className:"h-4 w-4"}),"Files"]})}),e.jsx(J,{className:"p-0",children:e.jsx("div",{className:"space-y-1",children:r.files.map(t=>{var n;return e.jsxs("button",{onClick:()=>v(t),className:`w-full text-left px-4 py-2 text-sm hover:bg-muted transition-colors flex items-center gap-2 ${((n=r.currentFile)==null?void 0:n.path)===t.path?"bg-muted":""}`,children:[e.jsx(le,{className:"h-4 w-4"}),e.jsx("span",{className:"truncate",children:t.name}),t.modified&&e.jsx("div",{className:"w-2 h-2 bg-blue-600 rounded-full ml-auto"})]},t.path)})})})]})}),e.jsx("div",{className:"col-span-9",children:r.currentFile?e.jsx(pe,{value:S,onChange:D,language:r.currentFile.language,height:"100%",onSave:y,fileName:r.currentFile.name,readOnly:r.previewMode}):e.jsx(V,{className:"h-full",children:e.jsx(J,{className:"h-full flex items-center justify-center",children:e.jsxs("div",{className:"text-center",children:[e.jsx(K,{className:"h-12 w-12 text-muted-foreground mx-auto mb-4"}),e.jsx("h3",{className:"text-lg font-semibold mb-2",children:"No File Selected"}),e.jsx("p",{className:"text-muted-foreground",children:"Select a file from the explorer to start editing"})]})})})})]}),e.jsxs("div",{className:"flex items-center justify-between text-sm text-muted-foreground bg-muted/50 px-4 py-2 rounded",children:[e.jsxs("div",{className:"flex items-center gap-4",children:[e.jsxs("span",{children:["Theme: ",s.metadata.name]}),e.jsxs("span",{children:["Version: ",s.metadata.version]}),r.currentFile&&e.jsxs("span",{children:["Editing: ",r.currentFile.name]})]}),e.jsxs("div",{className:"flex items-center gap-2",children:[r.hasUnsavedChanges&&e.jsx("span",{className:"text-orange-600",children:"● Unsaved changes"}),e.jsxs("span",{children:["Files: ",r.files.length]})]})]})]}):e.jsx("div",{className:"p-6",children:e.jsxs(Y,{variant:"destructive",children:[e.jsx(oe,{className:"h-4 w-4"}),e.jsx(_,{children:"No active theme found. Please activate a theme first."})]})})}export{$e as default};
