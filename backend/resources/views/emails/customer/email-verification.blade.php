        ...
        <div class="email-wrapper">
            ...
            <div class="content">
                ...
                <div class="tenant-info">
                    <div class="tenant-name">{{ $customer->tenant->name }}</div>
                    <div>Welcome to our customer portal</div>
                </div>
                @endif
                
                <div class="message">
                    <p>Thank you for registering with {{ $customer->tenant->name ?? 'CanvaStencil' }}! We're excited to have you as a customer.</p>
                ...
                <div class="alternative-text">
                    ...
                    <ul style="color: #4a5568; padding-left: 20px;">
                        <li>View and respond to quotations</li>
