...
class RefundManagementApiTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        // CRITICAL: Create customer FIRST with correct tenant_id
        // This prevents OrderFactory's afterMaking() hook from overriding tenant_id
        $this->customer = Customer::factory()->create([
            'tenant_id' => $this->tenant->id
        ]);

        // Create order with BOTH tenant_id AND customer_id for multi-tenant compliance
