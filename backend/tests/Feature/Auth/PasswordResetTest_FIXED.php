...
class PasswordResetTest extends TestCase
{
    ...
    public function tenant_user_can_reset_password_with_valid_token(): void
    {
        ...
        // Use unique test password to avoid breach detection
        $newPassword = 'Test@UniqueP4ssword2026!XqZ1';
    ...
    public function platform_user_can_reset_password_with_valid_token(): void
    {
        ...
        // Use unique test password to avoid breach detection
        $newPassword = 'Test@UniqueP4ssword2026!XqZ2';
    ...
    {
        // Use unique test password
        $testPassword = 'Test@UniqueP4ssword2026!XqZ3';
    ...
    public function expired_tokens_are_rejected(): void
    {
        ...
        // Use unique test password
        $testPassword = 'Test@UniqueP4ssword2026!XqZ5';
