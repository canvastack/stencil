...
class TenantFooterConfigSeeder extends Seeder
{
    ...
    private function getDefaultFooterTemplate(): array
    {
        return [
            ...
            'social_links' => [
                ['platform' => 'Facebook', 'url' => 'https://facebook.com/etchingxenial', 'icon' => 'Facebook'],
                ['platform' => 'Instagram', 'url' => 'https://instagram.com/etchingxenial', 'icon' => 'Instagram'],
                ['platform' => 'LinkedIn', 'url' => 'https://linkedin.com/company/etchingxenial', 'icon' => 'Linkedin'],
                ['platform' => 'YouTube', 'url' => 'https://youtube.com/@etchingxenial', 'icon' => 'Youtube'],
            ],
    ...
    private function getMinimalFooterTemplate(): array
    {
        return [
            ...
            'contact_phone' => '+62 81252525599',
            'contact_email' => 'info@etchingxenial.com',
            'contact_working_hours' => 'Mon - Fri: 09:00 - 18:00',
            'social_links' => [
                ['platform' => 'Instagram', 'url' => 'https://instagram.com/etchingxenial', 'icon' => 'Instagram'],
                ['platform' => 'Facebook', 'url' => 'https://facebook.com/etchingxenial', 'icon' => 'Facebook'],
                ['platform' => 'LinkedIn', 'url' => 'https://linkedin.com/company/etchingxenial', 'icon' => 'Linkedin'],
    ...
    private function getModernFooterTemplate(): array
    {
        return [
            ...
            'social_links' => [
                ['platform' => 'Facebook', 'url' => 'https://facebook.com/etchingxenial', 'icon' => 'Facebook'],
                ['platform' => 'Instagram', 'url' => 'https://instagram.com/etchingxenial', 'icon' => 'Instagram'],
                ['platform' => 'Twitter', 'url' => 'https://x.com/etchingxenial', 'icon' => 'Twitter'],
                ['platform' => 'LinkedIn', 'url' => 'https://linkedin.com/company/etchingxenial', 'icon' => 'Linkedin'],
                ['platform' => 'WhatsApp', 'url' => 'https://wa.me/6281252525599', 'icon' => 'MessageCircle'],
            ],
            'show_newsletter' => true,
