...
export default function Product3DViewer({ productType = "plaque", imageUrl }: Product3DViewerProps) {
  return (
    <div className={`w-full h-[${APP_CONFIG.VIEWER_HEIGHT}px] rounded-lg overflow-hidden bg-gradient-to-b from-background to-muted`}>
      <Canvas shadows>
        ...
        <Suspense fallback={<Loader />}>
          <EtchedPlaque imageUrl={imageUrl} />
