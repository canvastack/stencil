import{j as e}from"./ui-vendor-CzLWDOsI.js";import{am as K,C as g,d as j,ai as I,a as M,b as V,a4 as Q,c as R,a9 as u,L as h,R as W,e as X,a3 as Y,ag as _,as as ee,I as z,T as se,aq as te,B as y,a0 as ae,p as oe}from"./index-CA1Fui7q.js";import{r as B,c as ne}from"./react-vendor-92AQlTAG.js";import{P as re}from"./progress-DGMfyAj_.js";import{A as J,a as U}from"./alert-ByRl8DZI.js";import{J as ie}from"./jszip.min-VaQned3v.js";import{I as ce}from"./info-D97ENJ6t.js";import{D as me}from"./download-DrC4LZTf.js";import"./three-vendor-CaHj5NkI.js";function le(){const{currentTheme:s,currentThemeName:N}=K(),[o,H]=B.useState({includeComponents:!0,includeAssets:!0,includeStyles:!0,includeDocumentation:!0,includeMetadata:!0,customName:"",customVersion:"",customDescription:""}),[i,r]=B.useState({isExporting:!1,exportProgress:0,exportComplete:!1,exportError:null,exportedFileName:null}),l=(t,d)=>{H(x=>({...x,[t]:d}))},Z=async()=>{var x,p,f,C,v,b,$,E,k,w,S,T,D,A,P,O,F,L;const t=new ie;if(!s)throw new Error("No active theme to export");if(r(a=>({...a,exportProgress:10})),o.includeMetadata){const a={...s.metadata,name:o.customName||s.metadata.name,version:o.customVersion||s.metadata.version,description:o.customDescription||s.metadata.description,exportedAt:new Date().toISOString(),exportedBy:"Theme Manager"};t.file("theme.json",JSON.stringify(a,null,2)),r(n=>({...n,exportProgress:20}))}if(o.includeComponents){const a=t.folder("components");Object.entries(s.components).forEach(([n,c])=>{if(c){const m=`import React from 'react';
...
export default ${n};
`;a==null||a.file(`${n}.tsx`,m)}}),r(n=>({...n,exportProgress:40}))}if(o.includeAssets){const a=t.folder("assets");if((x=s.assets)!=null&&x.images){const n=a==null?void 0:a.folder("images");Object.entries(s.assets.images).forEach(([c,m])=>{n==null||n.file(`${c}.placeholder`,`Image placeholder for ${m}`)})}if((p=s.assets)!=null&&p.fonts){const n=a==null?void 0:a.folder("fonts");Object.entries(s.assets.fonts).forEach(([c,m])=>{n==null||n.file(`${c}.placeholder`,`Font placeholder for ${m}`)})}r(n=>({...n,exportProgress:60}))}if(o.includeStyles){const a=t.folder("styles"),n=`/* ${s.metadata.name} Theme Styles */
...
${(L=s.config)!=null&&L.features?Object.entries(s.config.features).map(([c,m])=>`- ${c}: ${m?"Enabled":"Disabled"}`).join(`
`):"- No specific features documented"}

## Components

${Object.keys(s.components).map(c=>`- ${c}`).join(`
`)}
