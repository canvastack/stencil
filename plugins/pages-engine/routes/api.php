...
Route::prefix('cms')->group(function () {
    ...
    Route::prefix('admin')->middleware(['auth:sanctum', 'tenant.context'])->group(function () {
        ...
        Route::prefix('categories')->group(function () {
            ...
            Route::post('/{uuid}/move', [AdminCategoryController::class, 'move'])->name('cms.admin.categories.move');
            Route::post('/{uuid}/reorder', [AdminCategoryController::class, 'reorder'])->name('cms.admin.categories.reorder');
        });
