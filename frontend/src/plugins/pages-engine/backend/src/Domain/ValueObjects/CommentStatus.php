...
final class CommentStatus
{
    ...
    private const ALLOWED_TRANSITIONS = [
        self::PENDING => [self::APPROVED, self::REJECTED, self::SPAM, self::TRASH],
        self::APPROVED => [self::REJECTED, self::SPAM, self::TRASH],
        self::REJECTED => [self::APPROVED, self::SPAM, self::TRASH],
