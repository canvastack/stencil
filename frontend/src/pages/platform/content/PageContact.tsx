...
export default function PageContact() {
  ...
  const handleSave = async () => {
    try {
      ...
      if (success) {
        toast.success("Platform contact page content saved successfully!");
        setHasChanges(false);
      } else {
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Platform Contact Page Content</h1>
          <p className="text-muted-foreground">Manage platform contact information and form settings</p>
        </div>
      ...
      <Tabs defaultValue="hero" className="space-y-4">
        ...
        <TabsContent value="info" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Update platform contact details</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        <TabsContent value="form" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure form fields and validation for platform inquiries</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between p-4 border rounded-lg">
                <div className="space-y-1">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  <Label>Service Interest Options</Label>
                  <Button
                    size="sm"
                    variant="outline"
                    onClick={() => {
                      const currentOptions = formData.form?.serviceOptions || [];
                      setFormData({
                        ...formData,
                        form: {
                          ...formData.form,
                          serviceOptions: [...currentOptions, { value: '', label: '' }]
                        }
                      });
                      setHasChanges(true);
                    }}
                ...
                <p className="text-sm text-muted-foreground">
                  Configure the options for "I'm interested in" dropdown field
                </p>

                {(formData.form?.serviceOptions || []).map((option: any, index: number) => (
                  <Card key={index} className="p-4">
                    <div className="space-y-3">
                      <div className="flex items-center justify-between">
                        <Label className="font-semibold">Option #{index + 1}</Label>
                        <Button
                          size="sm"
                          variant="outline"
                          onClick={() => {
                            const newOptions = (formData.form?.serviceOptions || []).filter((_: any, i: number) => i !== index);
                            setFormData({
                              ...formData,
                              form: { ...formData.form, serviceOptions: newOptions }
                            });
                            setHasChanges(true);
                          }}
                        >
                      ...
                      <div className="grid md:grid-cols-2 gap-3">
                        <div className="space-y-2">
                          ...
                          <Input
                            ...
                            value={option.value}
                            onChange={(e) => {
                              const newOptions = [...(formData.form?.serviceOptions || [])];
        ...
        <TabsContent value="quick" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Configure quick contact methods for platform inquiries</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  placeholder="Hello! I'm interested in your platform services..."
              ...
              <div className="space-y-2">
                ...
                <Input
                  type="email"
                  placeholder="contact@canvastencil.com"
        ...
        <TabsContent value="achievements" className="space-y-4">
          <Card>
            <CardHeader>
              <CardTitle>Platform Achievements Section</CardTitle>
              <CardDescription>Display platform achievements and statistics</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
        ...
        <TabsContent value="whyChooseUs" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Highlight platform benefits and features</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <Textarea
                          ...
                          placeholder="Platform features that make it easy to manage business websites..."
                          rows={3}
                          onChange={(e) => {
                            const newItems = [...(formData.whyChooseUs?.items || [])];
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            placeholder="Ready to Start Your Business Website?"
                            onChange={(e) => {
                              const currentItems = Array.isArray(formData.cta) ? formData.cta : formData.cta?.items || [];
                              const newItems = [...currentItems];
                              newItems[index] = { ...newItems[index], title: e.target.value };
